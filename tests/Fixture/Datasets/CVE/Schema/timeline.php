...
if (false === function_exists('provide_valid_timelines')) {
    /**
     * @return Timeline[]
     */
    function provide_valid_timelines(): array
    {
...
if (false === function_exists('provide_invalid_timelines')) {
    /**
     * @return Timeline[]
     */
    function provide_invalid_timelines(): array
    {
        $timeline_0 = new Timeline();
