...
if (false === function_exists('provide_valid_cvss30')) {
    /**
     * @return CVSS30[]
     */
    function provide_valid_cvss30(): array
    {
        $cvss_0 = new CVSS30();
...
if (false === function_exists('provide_invalid_cvss30')) {
    /**
     * @return CVSS30[]
     */
    function provide_invalid_cvss30(): array
    {
        $cvss_0 = new CVSS30();
