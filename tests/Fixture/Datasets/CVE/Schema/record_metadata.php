...
if (false === function_exists('provide_valid_record_metadata')) {
    /**
     * @return RecordMetadata[]
     */
    function provide_valid_record_metadata(): array
    {
...
if (false === function_exists('provide_invalid_record_metadata')) {
    /**
     * @return RecordMetadata[]
     */
    function provide_invalid_record_metadata(): array
    {
        $metadata_0 = new RecordMetadata();
