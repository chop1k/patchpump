...
if (false === function_exists('provide_valid_cpe_matches')) {
    /**
     * @return CPEMatch[]
     */
    function provide_valid_cpe_matches(): array
    {
...
if (false === function_exists('provide_invalid_cpe_matches')) {
    /**
     * @return CPEMatch[]
     */
    function provide_invalid_cpe_matches(): array
    {
        $match_0 = new CPEMatch();
