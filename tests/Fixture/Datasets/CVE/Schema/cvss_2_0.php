...
const CVSS20_VECTOR = 'AV:N/AC:L/Au:N/C:P/I:P/A:C';

if (false === function_exists('provide_valid_cvss20')) {
    /**
     * @return CVSS20[]
     */
    function provide_valid_cvss20(): array
    {
        $cvss_0 = new CVSS20();

        $cvss_0->version = '2.0';
        $cvss_0->baseScore = 2;
        $cvss_0->vectorString = CVSS20_VECTOR;

        $cvss_1 = new CVSS20();

        $cvss_1->version = '2.0';
        $cvss_1->baseScore = 2;
        $cvss_1->vectorString = CVSS20_VECTOR;
        ...
        $cvss_2->version = '2.0';
        $cvss_2->baseScore = 2;
        $cvss_2->vectorString = CVSS20_VECTOR;
        ...
        $cvss_3->version = '2.0';
        $cvss_3->baseScore = 2;
        $cvss_3->vectorString = CVSS20_VECTOR;
        ...
        $cvss_4->version = '2.0';
        $cvss_4->baseScore = 2;
        $cvss_4->vectorString = CVSS20_VECTOR;
        ...
        $cvss_5->version = '2.0';
        $cvss_5->baseScore = 2;
        $cvss_5->vectorString = CVSS20_VECTOR;
        ...
        $cvss_6->version = '2.0';
        $cvss_6->baseScore = 2;
        $cvss_6->vectorString = CVSS20_VECTOR;
        ...
        $cvss_7->version = '2.0';
        $cvss_7->baseScore = 2;
        $cvss_7->vectorString = CVSS20_VECTOR;
        ...
        $cvss_8->version = '2.0';
        $cvss_8->baseScore = 2;
        $cvss_8->vectorString = CVSS20_VECTOR;
        ...
        $cvss_9->version = '2.0';
        $cvss_9->baseScore = 2;
        $cvss_9->vectorString = CVSS20_VECTOR;
        ...
        $cvss_10->version = '2.0';
        $cvss_10->baseScore = 2;
        $cvss_10->vectorString = CVSS20_VECTOR;
        ...
        $cvss_11->version = '2.0';
        $cvss_11->baseScore = 2;
        $cvss_11->vectorString = CVSS20_VECTOR;
        ...
        $cvss_12->version = '2.0';
        $cvss_12->baseScore = 2;
        $cvss_12->vectorString = CVSS20_VECTOR;
        ...
        $cvss_13->version = '2.0';
        $cvss_13->baseScore = 2;
        $cvss_13->vectorString = CVSS20_VECTOR;
        ...
        $cvss_14->version = '2.0';
        $cvss_14->baseScore = 2;
        $cvss_14->vectorString = CVSS20_VECTOR;
        ...
        $cvss_15->version = '2.0';
        $cvss_15->baseScore = 2;
        $cvss_15->vectorString = CVSS20_VECTOR;
        ...
        $cvss_16->version = '2.0';
        $cvss_16->baseScore = 2;
        $cvss_16->vectorString = CVSS20_VECTOR;
        ...
        $cvss_17->version = '2.0';
        $cvss_17->baseScore = 2;
        $cvss_17->vectorString = CVSS20_VECTOR;
        ...
        $cvss_18->version = '2.0';
        $cvss_18->baseScore = 2;
        $cvss_18->vectorString = CVSS20_VECTOR;
...
if (false === function_exists('provide_invalid_cvss20')) {
    /**
     * @return CVSS20[]
     */
    function provide_invalid_cvss20(): array
    {
        $cvss_0 = new CVSS20();
        ...
        $cvss_19->version = '2.0';
        $cvss_19->baseScore = 2;
        $cvss_19->vectorString = CVSS20_VECTOR;
        ...
        $cvss_20->version = '2.0';
        $cvss_20->baseScore = 2;
        $cvss_20->vectorString = CVSS20_VECTOR;
        ...
        $cvss_21->version = '2.0';
        $cvss_21->baseScore = 2;
        $cvss_21->vectorString = CVSS20_VECTOR;
