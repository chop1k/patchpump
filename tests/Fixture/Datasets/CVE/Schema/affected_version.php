...
if (false === function_exists('provide_valid_affected_versions')) {
    /**
     * @return AffectedVersion[]
     */
    function provide_valid_affected_versions(): array
    {
        ...
        $version_4->changes = provide_invalid_affected_version_changes();
        ...
        $version_5->changes = provide_invalid_affected_version_changes();
        ...
        $version_6->changes = provide_invalid_affected_version_changes();
        ...
        $version_7->changes = provide_invalid_affected_version_changes();
...
if (false === function_exists('provide_invalid_affected_versions')) {
    /**
     * @return AffectedVersion[]
     */
    function provide_invalid_affected_versions(): array
    {
        $version_0 = new AffectedVersion();
        ...
        $version_11->changes = provide_invalid_affected_version_changes();
