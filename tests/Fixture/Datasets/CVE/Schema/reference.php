...
if (false === function_exists('provide_valid_references')) {
    /**
     * @return Reference[]
     */
    function provide_valid_references(): array
    {
...
if (false === function_exists('provide_invalid_references')) {
    /**
     * @return Reference[]
     */
    function provide_invalid_references(): array
    {
        $reference_0 = new Reference();
