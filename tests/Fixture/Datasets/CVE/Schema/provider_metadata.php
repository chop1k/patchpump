...
if (false === function_exists('provide_valid_provider_metadata')) {
    /**
     * @return ProviderMetadata[]
     */
    function provide_valid_provider_metadata(): array
    {
...
if (false === function_exists('provide_invalid_provider_metadata')) {
    /**
     * @return ProviderMetadata[]
     */
    function provide_invalid_provider_metadata(): array
    {
        $metadata_0 = new ProviderMetadata();
