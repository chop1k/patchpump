...
const CVSS40_VECTOR = 'CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:N/VI:N/VA:H/SC:N/SI:N/SA:N/AU:Y/R:A/V:C/RE:M/U:Green';

if (false === function_exists('provide_valid_cvss40')) {
    /**
     * @return CVSS40[]
     */
    function provide_valid_cvss40(): array
    {
        $cvss_0 = new CVSS40();

        $cvss_0->version = '4.0';
        $cvss_0->vectorString = CVSS40_VECTOR;
        $cvss_0->baseScore = 3;
        ...
        $cvss_1->version = '4.0';
        $cvss_1->vectorString = CVSS40_VECTOR;
        $cvss_1->baseScore = 0;
        ...
        $cvss_2->version = '4.0';
        $cvss_2->vectorString = CVSS40_VECTOR;
        $cvss_2->baseScore = 3;
        ...
        $cvss_3->version = '4.0';
        $cvss_3->vectorString = CVSS40_VECTOR;
        $cvss_3->baseScore = 3;
        ...
        $cvss_4->version = '4.0';
        $cvss_4->vectorString = CVSS40_VECTOR;
        $cvss_4->baseScore = 3;
        ...
        $cvss_5->version = '4.0';
        $cvss_5->vectorString = CVSS40_VECTOR;
        $cvss_5->baseScore = 3;
        ...
        $cvss_6->version = '4.0';
        $cvss_6->vectorString = CVSS40_VECTOR;
        $cvss_6->baseScore = 3;
        ...
        $cvss_7->version = '4.0';
        $cvss_7->vectorString = CVSS40_VECTOR;
        $cvss_7->baseScore = 3;
        ...
        $cvss_8->version = '4.0';
        $cvss_8->vectorString = CVSS40_VECTOR;
        $cvss_8->baseScore = 3;
        ...
        $cvss_9->version = '4.0';
        $cvss_9->vectorString = CVSS40_VECTOR;
        $cvss_9->baseScore = 3;
        ...
        $cvss_10->version = '4.0';
        $cvss_10->vectorString = CVSS40_VECTOR;
        $cvss_10->baseScore = 3;
        ...
        $cvss_11->version = '4.0';
        $cvss_11->vectorString = CVSS40_VECTOR;
        $cvss_11->baseScore = 3;
        ...
        $cvss_12->version = '4.0';
        $cvss_12->vectorString = CVSS40_VECTOR;
        $cvss_12->baseScore = 3;
        ...
        $cvss_13->version = '4.0';
        $cvss_13->vectorString = CVSS40_VECTOR;
        $cvss_13->baseScore = 3;
        ...
        $cvss_14->version = '4.0';
        $cvss_14->vectorString = CVSS40_VECTOR;
        $cvss_14->baseScore = 3;
        ...
        $cvss_15->version = '4.0';
        $cvss_15->vectorString = CVSS40_VECTOR;
        $cvss_15->baseScore = 3;
        ...
        $cvss_16->version = '4.0';
        $cvss_16->vectorString = CVSS40_VECTOR;
        $cvss_16->baseScore = 3;
        ...
        $cvss_17->version = '4.0';
        $cvss_17->vectorString = CVSS40_VECTOR;
        $cvss_17->baseScore = 3;
        ...
        $cvss_18->version = '4.0';
        $cvss_18->vectorString = CVSS40_VECTOR;
        $cvss_18->baseScore = 3;
        ...
        $cvss_19->version = '4.0';
        $cvss_19->vectorString = CVSS40_VECTOR;
        $cvss_19->baseScore = 3;
        ...
        $cvss_20->version = '4.0';
        $cvss_20->vectorString = CVSS40_VECTOR;
        $cvss_20->baseScore = 3;
        ...
        $cvss_21->version = '4.0';
        $cvss_21->vectorString = CVSS40_VECTOR;
        $cvss_21->baseScore = 3;
        ...
        $cvss_22->version = '4.0';
        $cvss_22->vectorString = CVSS40_VECTOR;
        $cvss_22->baseScore = 3;
        ...
        $cvss_23->version = '4.0';
        $cvss_23->vectorString = CVSS40_VECTOR;
        $cvss_23->baseScore = 3;
        ...
        $cvss_24->version = '4.0';
        $cvss_24->vectorString = CVSS40_VECTOR;
        $cvss_24->baseScore = 3;
        ...
        $cvss_25->version = '4.0';
        $cvss_25->vectorString = CVSS40_VECTOR;
        $cvss_25->baseScore = 3;
        ...
        $cvss_26->version = '4.0';
        $cvss_26->vectorString = CVSS40_VECTOR;
        $cvss_26->baseScore = 3;
        ...
        $cvss_27->version = '4.0';
        $cvss_27->vectorString = CVSS40_VECTOR;
        $cvss_27->baseScore = 3;
        ...
        $cvss_28->version = '4.0';
        $cvss_28->vectorString = CVSS40_VECTOR;
        $cvss_28->baseScore = 3;
        ...
        $cvss_29->version = '4.0';
        $cvss_29->vectorString = CVSS40_VECTOR;
        $cvss_29->baseScore = 3;
        ...
        $cvss_30->version = '4.0';
        $cvss_30->vectorString = CVSS40_VECTOR;
        $cvss_30->baseScore = 3;
        ...
        $cvss_31->version = '4.0';
        $cvss_31->vectorString = CVSS40_VECTOR;
        $cvss_31->baseScore = 3;
        ...
        $cvss_32->version = '4.0';
        $cvss_32->vectorString = CVSS40_VECTOR;
        $cvss_32->baseScore = 3;
        ...
        $cvss_33->version = '4.0';
        $cvss_33->vectorString = CVSS40_VECTOR;
        $cvss_33->baseScore = 3;
...
if (false === function_exists('provide_invalid_cvss40')) {
    /**
     * @return CVSS40[]
     */
    function provide_invalid_cvss40(): array
    {
        $cvss_0 = new CVSS40();
        ...
        $cvss_34->version = '4.0';
        $cvss_34->vectorString = CVSS40_VECTOR;
        $cvss_34->baseScore = 3;
        ...
        $cvss_35->version = '4.0';
        $cvss_35->vectorString = CVSS40_VECTOR;
        $cvss_35->baseScore = 3;
        ...
        $cvss_36->version = '4.0';
        $cvss_36->vectorString = CVSS40_VECTOR;
        $cvss_36->baseScore = 3;
        ...
        $cvss_37->version = '4.0';
        $cvss_37->vectorString = CVSS40_VECTOR;
        $cvss_37->baseScore = 3;
        ...
        $cvss_38->version = '4.0';
        $cvss_38->vectorString = CVSS40_VECTOR;
        $cvss_38->baseScore = 3;
        ...
        $cvss_39->version = '4.0';
        $cvss_39->vectorString = CVSS40_VECTOR;
        $cvss_39->baseScore = 3;
        ...
        $cvss_40->version = '4.0';
        $cvss_40->vectorString = CVSS40_VECTOR;
        $cvss_40->baseScore = 3;
        ...
        $cvss_41->version = '4.0';
        $cvss_41->vectorString = CVSS40_VECTOR;
        $cvss_41->baseScore = 3;
        ...
        $cvss_42->version = '4.0';
        $cvss_42->vectorString = CVSS40_VECTOR;
        $cvss_42->baseScore = 3;
        ...
        $cvss_43->version = '4.0';
        $cvss_43->vectorString = CVSS40_VECTOR;
        $cvss_43->baseScore = 3;
        ...
        $cvss_44->version = '4.0';
        $cvss_44->vectorString = CVSS40_VECTOR;
        $cvss_44->baseScore = 3;
        ...
        $cvss_45->version = '4.0';
        $cvss_45->vectorString = CVSS40_VECTOR;
        $cvss_45->baseScore = 3;
        ...
        $cvss_46->version = '4.0';
        $cvss_46->vectorString = CVSS40_VECTOR;
        $cvss_46->baseScore = 3;
        ...
        $cvss_47->version = '4.0';
        $cvss_47->vectorString = CVSS40_VECTOR;
        $cvss_47->baseScore = 3;
        ...
        $cvss_48->version = '4.0';
        $cvss_48->vectorString = CVSS40_VECTOR;
        $cvss_48->baseScore = 3;
        ...
        $cvss_49->version = '4.0';
        $cvss_49->vectorString = CVSS40_VECTOR;
        $cvss_49->baseScore = 3;
        ...
        $cvss_50->version = '4.0';
        $cvss_50->vectorString = CVSS40_VECTOR;
        $cvss_50->baseScore = 3;
        ...
        $cvss_51->version = '4.0';
        $cvss_51->vectorString = CVSS40_VECTOR;
        $cvss_51->baseScore = 3;
        ...
        $cvss_52->version = '4.0';
        $cvss_52->vectorString = CVSS40_VECTOR;
        $cvss_52->baseScore = 3;
        ...
        $cvss_53->version = '4.0';
        $cvss_53->vectorString = CVSS40_VECTOR;
        $cvss_53->baseScore = 3;
        ...
        $cvss_54->version = '4.0';
        $cvss_54->vectorString = CVSS40_VECTOR;
        $cvss_54->baseScore = 3;
        ...
        $cvss_55->version = '4.0';
        $cvss_55->vectorString = CVSS40_VECTOR;
        $cvss_55->baseScore = 3;
        ...
        $cvss_56->version = '4.0';
        $cvss_56->vectorString = CVSS40_VECTOR;
        $cvss_56->baseScore = 3;
        ...
        $cvss_57->version = '4.0';
        $cvss_57->vectorString = CVSS40_VECTOR;
        $cvss_57->baseScore = 3;
        ...
        $cvss_58->version = '4.0';
        $cvss_58->vectorString = CVSS40_VECTOR;
        $cvss_58->baseScore = 3;
        ...
        $cvss_59->version = '4.0';
        $cvss_59->vectorString = CVSS40_VECTOR;
        $cvss_59->baseScore = 3;
        ...
        $cvss_60->version = '4.0';
        $cvss_60->vectorString = CVSS40_VECTOR;
        $cvss_60->baseScore = 3;
        ...
        $cvss_61->version = '4.0';
        $cvss_61->vectorString = CVSS40_VECTOR;
        $cvss_61->baseScore = 3;
        ...
        $cvss_62->version = '4.0';
        $cvss_62->vectorString = CVSS40_VECTOR;
        $cvss_62->baseScore = 3;
        ...
        $cvss_63->version = '4.0';
        $cvss_63->vectorString = CVSS40_VECTOR;
        $cvss_63->baseScore = 3;
        ...
        $cvss_64->version = '4.0';
        $cvss_64->vectorString = CVSS40_VECTOR;
        $cvss_64->baseScore = 3;
        ...
        $cvss_65->version = '4.0';
        $cvss_65->vectorString = CVSS40_VECTOR;
        $cvss_65->baseScore = 3;
        ...
        $cvss_66->version = '4.0';
        $cvss_66->vectorString = CVSS40_VECTOR;
        $cvss_66->baseScore = 3;
        ...
        $cvss_67->version = '4.0';
        $cvss_67->vectorString = CVSS40_VECTOR;
        $cvss_67->baseScore = 3;
        ...
        $cvss_68->version = '4.0';
        $cvss_68->vectorString = CVSS40_VECTOR;
        $cvss_68->baseScore = 3;
        ...
        $cvss_69->version = '4.0';
        $cvss_69->vectorString = CVSS40_VECTOR;
        $cvss_69->baseScore = 3;
        ...
        $cvss_70->version = '4.0';
        $cvss_70->vectorString = CVSS40_VECTOR;
        $cvss_70->baseScore = 3;
        ...
        $cvss_71->version = '4.0';
        $cvss_71->vectorString = CVSS40_VECTOR;
        $cvss_71->baseScore = 3;
        ...
        $cvss_72->version = '4.0';
        $cvss_72->vectorString = CVSS40_VECTOR;
        $cvss_72->baseScore = 3;
        ...
        $cvss_73->version = '4.0';
        $cvss_73->vectorString = CVSS40_VECTOR;
        $cvss_73->baseScore = 3;
        ...
        $cvss_74->version = '4.0';
        $cvss_74->vectorString = CVSS40_VECTOR;
        $cvss_74->baseScore = 3;
        ...
        $cvss_75->version = '4.0';
        $cvss_75->vectorString = CVSS40_VECTOR;
        $cvss_75->baseScore = 3;
        ...
        $cvss_76->version = '4.0';
        $cvss_76->vectorString = CVSS40_VECTOR;
        $cvss_76->baseScore = 3;
        ...
        $cvss_77->version = '4.0';
        $cvss_77->vectorString = CVSS40_VECTOR;
        $cvss_77->baseScore = 3;
