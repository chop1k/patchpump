...
if (false === function_exists('provide_valid_affected')) {
    /**
     * @return Affected[]
     */
    function provide_valid_affected(): array
    {
        ...
        $affected_1->versions = provide_valid_affected_versions();
...
if (false === function_exists('provide_invalid_affected')) {
    /**
     * @return Affected[]
     */
    function provide_invalid_affected(): array
    {
        $affected_0 = new Affected();
        ...
        $affected_25->programRoutines = [
            null,
            ...provide_valid_affected_routines(),
        ];
        ...
        $affected_26->programRoutines = provide_invalid_affected_routines();
        ...
        $affected_34->versions = provide_invalid_affected_routines();
