...
use App\Tests\Common\Providers\Domain\CVE\Schema\TimelineProvider;
use App\Tests\Common\SchemaTest;
use PHPUnit\Framework\Attributes\DataProvider;

final class TimelineTest extends SchemaTest
{
    ...
    {
        return parent::mapRules(TimelineProvider::provideValid());
    }

    public static function provideInvalidRules(): iterable
    {
        return parent::mapRules(TimelineProvider::provideInvalid());
    }
}
