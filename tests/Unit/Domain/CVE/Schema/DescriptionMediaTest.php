...
class DescriptionMediaTest extends TestCase
{
     ...
     */
    public function testValidRules(DescriptionMedia $media): void
    {
     ...
     */
    public function testInvalidRules(DescriptionMedia $media): void
    {
        $errors = $this->validator->validate($media);
