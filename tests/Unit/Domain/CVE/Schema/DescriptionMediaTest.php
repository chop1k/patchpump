...
use App\Tests\Common\Providers\Domain\CVE\Schema\DescriptionMediaProvider;
use App\Tests\Common\SchemaTest;
use PHPUnit\Framework\Attributes\DataProvider;

final class DescriptionMediaTest extends SchemaTest
{
    ...
    {
        return parent::mapRules(DescriptionMediaProvider::provideValid());
    }

    public static function provideInvalidRules(): iterable
    {
        return parent::mapRules(DescriptionMediaProvider::provideInvalid());
    }
}
