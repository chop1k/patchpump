...
use App\Tests\Common\Providers\Domain\CVE\Schema\CPEApplicabilityProvider;
use App\Tests\Common\SchemaTest;
use PHPUnit\Framework\Attributes\DataProvider;

final class CPEApplicabilityTest extends SchemaTest
{
    ...
    {
        return parent::mapRules(CPEApplicabilityProvider::provideValid());
    }

    public static function provideInvalidRules(): iterable
    {
        return parent::mapRules(CPEApplicabilityProvider::provideInvalid());
    }
}