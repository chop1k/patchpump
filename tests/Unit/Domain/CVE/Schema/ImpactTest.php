...
use App\Tests\Common\Providers\CVE\ImpactProvider;
...
class ImpactTest extends TestCase
{
     ...
     */
    public function testValidRules(Impact $impact): void
    {
     ...
     */
    public function testInvalidRules(Impact $impact): void
    {
        $errors = $this->validator->validate($impact);
    ...
    {
        return array_map(
            static fn (Impact $impact) => [$impact],
