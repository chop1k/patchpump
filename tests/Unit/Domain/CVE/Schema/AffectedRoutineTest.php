...
use App\Tests\Common\Providers\CVE\AffectedRoutineProvider;
use PHPUnit\Framework\TestCase;
use Symfony\Component\Validator\Validator\ValidatorInterface;
use Symfony\Component\Validator\ValidatorBuilder;

class AffectedRoutineTest extends TestCase
{
     ...
     */
    public function testValidRules(AffectedRoutine $routine): void
    {
        $errors = $this->validator->validate($routine);
     ...
     */
    public function testInvalidRules(AffectedRoutine $routine): void
    {
        $errors = $this->validator->validate($routine);
    ...
    {
        return array_map(
            static fn (AffectedRoutine $routine) => [$routine],
    ...
    public static function provideInvalidRules(): iterable
    {
        return array_map(
            static fn (AffectedRoutine $routine) => [$routine],
            AffectedRoutineProvider::provideInvalid(),
        );
    }
}