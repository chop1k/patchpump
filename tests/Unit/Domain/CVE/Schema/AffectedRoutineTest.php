...
use App\Tests\Common\Providers\Domain\CVE\Schema\AffectedRoutineProvider;
use App\Tests\Common\SchemaTest;
use PHPUnit\Framework\Attributes\DataProvider;

final class AffectedRoutineTest extends SchemaTest
{
    ...
    {
        return parent::mapRules(AffectedRoutineProvider::provideValid());
    }

    public static function provideInvalidRules(): iterable
    {
        return parent::mapRules(AffectedRoutineProvider::provideInvalid());
    }
}
