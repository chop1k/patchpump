...
use App\Tests\Common\Providers\Domain\CVE\Schema\CVSS20Provider;
use App\Tests\Common\SchemaTest;
use PHPUnit\Framework\Attributes\DataProvider;

final class CVSS20Test extends SchemaTest
{
    ...
    {
        return parent::mapRules(CVSS20Provider::provideValid());
    }

    public static function provideInvalidRules(): iterable
    {
        return parent::mapRules(CVSS20Provider::provideInvalid());
    }
}
