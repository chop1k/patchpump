...
use App\Tests\Common\Providers\CVE\AffectedVersionProvider;
 ...
 */
class AffectedVersionTest extends TestCase
{
     ...
     */
    public function testValidRules(AffectedVersion $version): void
    {
     ...
     */
    public function testInvalidRules(AffectedVersion $version): void
    {
        $errors = $this->validator->validate($version);
    ...
    {
        return array_map(
            static fn (AffectedVersion $version) => [$version],
    ...
    public static function provideInvalidRules(): iterable
    {
        return array_map(
            static fn (AffectedVersion $version) => [$version],
            AffectedVersionProvider::provideInvalid(),
        );
    }
}