...
use App\Tests\Common\Providers\CVE\ProviderMetadataProvider;
...
class ProviderMetadataTest extends TestCase
{
     ...
     */
    public function testValidRules(ProviderMetadata $metadata): void
    {
     ...
     */
    public function testInvalidRules(ProviderMetadata $metadata): void
    {
        $errors = $this->validator->validate($metadata);
    ...
    {
        return array_map(
            static fn (ProviderMetadata $metadata) => [$metadata],
            ProviderMetadataProvider::provideValid(),
        );
    }
    ...
    public static function provideInvalidRules(): iterable
    {
        return array_map(
            static fn (ProviderMetadata $metadata) => [$metadata],
            ProviderMetadataProvider::provideInvalid(),
        );
    }
}